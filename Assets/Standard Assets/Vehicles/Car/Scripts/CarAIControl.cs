...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        [SerializeField] [Range(0, 1)] private float m_CautiousSpeedFactor = 0.03f;               // percentage of max speed to use when being maximally cautious
        ...
        [SerializeField] private float m_AccelSensitivity = 0.05f;                                // How sensitively the AI uses the accelerator to reach the current desired speed
        [SerializeField] private float m_BrakeSensitivity = 1.5f;                                   // How sensitively the AI uses the brake to reach the current desired speed
